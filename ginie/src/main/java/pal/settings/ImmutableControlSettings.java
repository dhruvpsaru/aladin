 ...
 */
public class ImmutableControlSettings implements ControlSettings {

    private final Map<String, String> map;

    private ImmutableControlSettings(Map<String, String> settings) {
    ...
    public static class Builder implements ControlSettings.Builder {
        ...
        public ControlSettings build() {
            return new ImmutableControlSettings(Collections.unmodifiableMap(map));
        }
    }
