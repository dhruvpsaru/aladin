...
public class EntityManagerFactoryProvider implements Provider<EntityManagerFactory> {
    ...
    @Inject
    public EntityManagerFactoryProvider(GinieSettings ginieSettings) {
        if (ENITY_MANAGER_FACTORY == null) {
            ENITY_MANAGER_FACTORY = createFactory(ginieSettings);
        }
    }
    ...
    private EntityManagerFactory createFactory(final GinieSettings settings) {
